...
{
    public class RefundPaymentRequestTests : UnitTestsOf<RefundPaymentRequest>
    {
        public RefundPaymentRequestTests()
        {
            SUT = new RefundPaymentRequest("transaction1", new Guid("3cf41244-dbac-48a6-9233-8291842f27bc"), 112.75m);
        }
