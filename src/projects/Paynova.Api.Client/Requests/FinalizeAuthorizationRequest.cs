...
{
    public class FinalizeAuthorizationRequest : Request
    {
        ...
        /// <summary>
        /// Gets the total amount to finalize. The amount must be equal to or less than the original authorized amount.
        /// </summary>
        ...
        /// via callback delivery, entity hook notification (EHN).
        /// </param>
        ...
        /// </param>
        public FinalizeAuthorizationRequest(string transactionId, decimal totalAmount)
        {
        ...
        /// The total amount to finalize. The amount must be equal to or less than the original authorized amount.
        /// </param>
        public FinalizeAuthorizationRequest(string transactionId, Guid orderId, decimal totalAmount)
        ...
        public virtual FinalizeAuthorizationRequest AddLineItem(LineItem item)
        {
        ...
        public virtual FinalizeAuthorizationRequest ClearLineItems()
        {
        ...
        public virtual FinalizeAuthorizationRequest WithLineItems(params LineItem[] items)
        {
        ...
        public virtual FinalizeAuthorizationRequest WithLineItems(IEnumerable<LineItem> items)
        {
