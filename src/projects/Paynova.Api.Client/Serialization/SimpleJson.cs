...
#define SIMPLE_JSON_DONT_SERIALIZE_NULL

#define SIMPLE_JSON_DONT_SERIALIZE_EMPTY_COLLECTIONS
...
#if SIMPLE_JSON_DONT_SERIALIZE_NULL
                if(value == null)
                    continue;
#endif

#if SIMPLE_JSON_DONT_SERIALIZE_EMPTY_COLLECTIONS
...
#if SIMPLE_JSON_HANDLE_ENUM_AS_STRING
                    if (type.IsEnum)
